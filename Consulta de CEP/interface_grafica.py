...
def tela_inicial():
    ...
    layout = [
        [sg.Text('Consulte o Cep', font='arial 18 bold', justification='center')],
    ...
    telaprin = sg.Window('Consultar CEP', element_padding=(0,10), layout=layout, size=(600,500), finalize=True)